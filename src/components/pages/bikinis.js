...
import { productDataBikinis } from "../Productos/Bikinis/data";
...
const Bikinis = ( ) => {
  ...
  const [items, setItems] = useState([...productDataBikinis].splice(0, ITEMS_PER_PAGE ))
  const [products, setProducts] = useState(productDataBikinis)
  ...
  const closeToggle = () =>  setActive(false);
    ...
    return (
        ...
        <div className="div-principal" onClick={closeToggle}>
            ...
            <DivContainerProducts section="Bikinis"  tallas={tallas} filterTalla={filterTalla} colores={colores} filterColor={filterColor}>
